...
for R1 in $FASTQ_DIR/*_1_m.fastq.gz; do
    # Replace '_1_m' with '_2_m' to find the matching reverse file
    R2=${R1/_1_m.fastq.gz/_2_m.fastq.gz}
    
    # Extract the sample name based on the file naming convention
    sample_name=$(basename $R1 _1_m.fastq.gz)
    
    # Define output prefix
    output_prefix="$OUTPUT_DIR/${sample_name}_m_"
